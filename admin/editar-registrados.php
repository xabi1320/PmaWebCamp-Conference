  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        ...
        <small>llenar el formulario para editar un Usuario manualmente</small>
      </h1>
    </section>
                    ...
                    <form class="editar-registrado" role="form"  name="guardar-registro" id="guardar-registro" method="post" action="modelo-registrado.php">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="apellido" name="apellido" value="<?php echo $registrado['apellido_registrado']; ?>">
                            </div>
                                            ...
                                            <li class="col-md-4">
                                                <div class="price-table text-center">
                                                    ...
                                                    <div class="order">
                                                        ...
                                                        <input value="<?php echo $boletos['un_dia']['quantity']; ?>" type="number" class="form-control" id="day_pass" min="0" size="3" name="tickets[un_dia][quantity]" placeholder="0">
                                            ...
                                            <li class="col-md-4">
                                                <div class="price-table text-center">
                                                    ...
                                                    <div class="order">
                                                        ...
                                                        <input value="<?php echo $boletos['pase_completo']['quantity']; ?>" type="number" class="form-control" id="full_pass" min="0" size="3" name="tickets[completo][quantity]" placeholder="0">
                                            ...
                                            <li class="col-md-4">
                                                <div class="price-table text-center">
                                                    ...
                                                    <div class="order">
                                                        ...
                                                        <input value="<?php echo $boletos['pase_2dias']['quantity']; ?>" type="number" class="form-control" id="day2_pass" min="0" size="3" name="tickets[dos_dias][quantity]" placeholder="0">
                                                    ...
                                                    <?php foreach($eventos['eventos'] as $tipo => $evento_dia): ?>
                                                        <div class="col-md-4">
                                                            ...
                                                            <?php foreach($evento_dia as $evento) { ?>
                                                                <label>
                                                                    <input <?php echo (in_array($evento['id'], $id_eventos_registrados['events']) ? 'checked' : '' ); ?> type="checkbox" class="minimal" name="registro_evento[]" id="<?php echo $evento['id']; ?>" value="<?php echo $evento['id']; ?>">
                                        ...
                                        <div class="box clearfix row">
                                            <div class="extras col-md-6">
                                                <div class="order">
                                                    ...
                                                    <input value="<?php echo $boletos['shirts']; ?>" type="number" class="form-control" min="0" id="shirt_event" name= "order_xtra[shirt][quantity]" size="3" placeholder="0">
                                                ...
                                                <div class="order">
                                                    ...
                                                    <input value="<?php echo $boletos['labels']; ?>" type="number" class="form-control" min="0" id="labels" size="3" name= "order_xtra[labels][quantity]"  placeholder="0">
                                                ...
                                                <div class="order">
                                                    ...
                                                    <select id="gift" name="gift" required class="form-control seleccionar">
                                                        ...
                                                        <option value="2" <?php echo ($registrado['regalo'] == 2 ) ? 'selected' : '' ?> >Etiqueta</option>
                                                        <option value="1" <?php echo ($registrado['regalo'] == 1 ) ? 'selected' : '' ?> >Pulseras</option>
                                                        <option value="3" <?php echo ($registrado['regalo'] == 3 ) ? 'selected' : '' ?> >Boligrafos</option>
                                                    </select>
                                                </div>
                                                <!--Order-->
                                                <br>
                        ...
                        <div class="box-footer">
                            ...
                            <button type="submit" class="btn btn-primary" id="btnRegistry">Guardar</button>
                        </div>
                    </form>
                </div>
                <!-- /.box-body -->
